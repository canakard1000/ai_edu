export const APP_ENV = {
  ...
  analysisPass3ProductId: import.meta.env.VITE_TOSS_ANALYSIS_3_PRODUCT_ID ?? '',
  analysisPass20ProductId: import.meta.env.VITE_TOSS_ANALYSIS_20_PRODUCT_ID ?? '',
  proProductId: import.meta.env.VITE_TOSS_PRO_PRODUCT_ID ?? '',
